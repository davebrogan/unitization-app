...
- [ ] 2. Create RehearsalForecast.Core class library
...
- [ ] 3. Create RehearsalForecast.Web ASP.NET Core MVC project
...
- [ ] 4. Create RehearsalForecast.Core.Tests xUnit test project
...
- [ ] 5. Create initial README.md stub
...
- [ ] 7. Implement MonthlySchedule<T> and ScheduleMode
...
- [ ] 9. Add result and output record types
...
- [ ] 10. Wire FsCheck.Xunit and add smoke test
...
- [ ] 11. Write unit tests for building geometry
...
- [ ] 12. Implement building geometry (Pass 1)
...
- [ ] 13. Write unit tests for occupancy schedule
...
- [ ] 14. Implement occupancy schedule (Pass 2)
...
- [ ] 15. Write unit tests for revenue
...
- [ ] 17. Write unit tests for marketing total
...
- [ ] 20. Implement operations total and payroll tax (Pass 5)
...
- [ ] 21. Write unit tests for depreciation
...
- [ ] 22. Implement depreciation (Pass 6)
...
- [ ] 23. Write unit tests for capital and financing sizing
...
- [ ] 24. Implement capital and financing sizing (Pass 7)
...
- [ ] 25. Write unit tests for LoanCalculator zero-proceeds and zero-interest cases
...
- [ ] 26. Write unit tests for LoanCalculator positive-interest case, term boundaries, and final-payment residual
...
- [ ] 27. Implement LoanCalculator: zero-proceeds and zero-interest regimes
...
- [ ] 28. Implement LoanCalculator: positive-interest regime with decimal Pow helper
...
- [ ] 29. Implement LoanCalculator: term boundaries and final-payment residual
...
- [ ] 30. Write unit tests for income tax and net income
...
- [ ] 31. Implement income tax and net income (Pass 9)
...
- [ ] 32. Write unit tests for cash-flow roll-forward
...
- [ ] 33. Implement cash-flow roll-forward (Pass 10)
...
- [ ] 34. Write unit tests for cash-positive rule and First_Sustained_Nonnegative_Month
...
- [ ] 35. Implement cash-positive rule and FSNM (Pass 11)
...
- [ ] 36. Assemble ForecastCalculator.Compute (Pass 12)
...
- [ ] 37. Write unit tests for PriceSolver
...
- [ ] 39. Write unit tests for InputValidator
...
- [ ] 41. Write unit tests for CsvExporter
...
- [ ] 43. Write property test — Property 1: Cash-flow accounting identity
...
- [ ] 44. Write property test — Property 2: Loan schedule invariants
...
- [ ] 45. Write property test — Property 3: Constant/Variable schedule equivalence
...
- [ ] 46. Write property test — Property 4: Building geometry
...
- [ ] 47. Write property test — Property 5: Occupancy clamping invariants
...
- [ ] 48. Write property test — Property 6: Monthly composition identities
...
- [ ] 49. Write property test — Property 7: Depreciation invariants
...
- [ ] 50. Write property test — Property 8: Capital summation and financing timing
...
- [ ] 51. Write property test — Property 9: Income tax and net income composition
...
- [ ] 52. Write property test — Property 10: First_Sustained_Nonnegative_Month semantics
...
- [ ] 53. Write property test — Property 11: Solver correctness contract
...
- [ ] 54. Write property test — Property 12: CSV export structure and determinism
...
- [ ] 56. Implement custom MonthlyScheduleModelBinder and OccupancyScheduleModelBinder
...
- [ ] 57. Implement ForecastController (Index, Calculate, ExportCsv)
...
- [ ] 58. Create _Layout.cshtml and site.css
...
- [ ] 59. Create _MonthlyScheduleEditor.cshtml partial
...
- [ ] 60. Create _OccupancyEditor.cshtml partial
...
- [ ] 61. Create Views/Forecast/Index.cshtml with 8 input sections
...
- [ ] 62. Create Views/Forecast/Results.cshtml with summary and 36-row detail table
...
- [ ] 63. Add horizontal-scroll + sticky-header/first-column CSS to results table
...
- [ ] 64. Wire Program.cs (DI, culture, logging, exception handler, model binder, antiforgery)
...
- [ ] 65. Add XML documentation across the Core public API
...
- [ ] 66. Add .vscode/launch.json and .vscode/tasks.json
...
- [ ] 67. Add multi-stage Dockerfile and .dockerignore
...
- [ ] 68. Create Terraform cloud_run module
...
- [ ] 69. Create Terraform environments/dev + tfvars.example + dev README
...
- [ ] 70. Create .github/workflows/ci.yml and workflows README
...
- [ ] 72. Run `dotnet format` (or `dotnet build /warnaserror` when the formatter is unavailable)
...
- [ ] 73. Run `dotnet build RehearsalForecast.sln`
...
- [ ] 75. Run Terraform fmt, init (no backend), validate
...
- [ ] 76. Run `docker build .` when Docker is available
...
- [ ] 77. Manual walkthrough: run the app and export a CSV
